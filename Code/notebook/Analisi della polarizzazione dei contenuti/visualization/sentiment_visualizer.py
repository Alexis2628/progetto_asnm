...
class SentimentVisualizer:
    ...
    def visualize_sentiment_distribution(self, sentiment_scores, cluster_labels):
        ...
        sns.violinplot(x="Cluster", y="Sentiment", data=data, hue="Cluster", palette="coolwarm", legend=False)
    ...
    def visualize_sentiment_vs_themes_heatmap(self, sentiment_scores, user_opinions, cluster_labels):
        ...
        sentiment_to_terms_corr = np.array([np.corrcoef(sentiment_array, tfidf_matrix[:, i].toarray().flatten())[0, 1]
