...
class GraphConstructor:
    def __init__(
        self, followers_path="../../data_extraction/followers_dataset_combined.csv"
    ):
    ...
    def build_graph(self):
        for user_id, user_info in self.user_data.items():
            ...
            self.graph.add_node(
                ...
                user_data=user_info.get("user_data_translated", []),
            )
            ...
            for follower in user_info.get("followers", []):
                ...
                self.graph.add_node(
                    ...
                    user_data=follower.get("user_data_translated", []),
                )
    ...
    def calculate_centralities(self):
        centralities = {
            ...
            "Katz Centrality": nx.katz_centrality(
                self.graph, alpha=0.1, beta=1.0, max_iter=1000, tol=1e-06
            ),
